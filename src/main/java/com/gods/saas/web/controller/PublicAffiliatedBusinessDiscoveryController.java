...
import com.gods.saas.domain.dto.request.AffiliatedDiscoveryEventRequest;
...
public class PublicAffiliatedBusinessDiscoveryController {
    ...
    @PostMapping("/events")
    public ResponseEntity<Void> recordEvent(@RequestBody AffiliatedDiscoveryEventRequest request) {
        discoveryService.recordEvent(request.branchId(), request.eventType());
