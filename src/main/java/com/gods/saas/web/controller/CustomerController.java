...
import org.springframework.web.bind.annotation.*;
    ...
    public class CustomerController {
        ...
        public Customer crearClientePorVenta(@RequestBody VentaRapidaRequest request) {
            return customerService.registrarCliente(
                    request
            );
        }
        ...
        // com.gods.saas.web.controller.UserController
        ...
        public ResponseEntity<ClienteResponse> actualizarCliente(
            ...
            String token = authHeader.replace("Bearer ", "");
            Long tenantId = jwtUtil.getTenantIdFromToken(token); // ahora te doy este método

            Customer actualizado = customerService.actualizarCliente(clienteId, request);
        ...
        public ResponseEntity<ClienteResponse> getByPhone(
            ...
            Customer user = customerService.obtenerClientePorTelefono(2L, phone);
        ...
        public ResponseEntity<ClienteResponse> getByTelefono(
            ...
            Customer u = customerService.obtenerClientePorTelefono(2L, telefono);
        ...
        public ResponseEntity<?> recuperarCuenta(@RequestBody CambiarTelefonoRequest req) {
            ...
            RecuperarTelefonoResponse resp = new RecuperarTelefonoResponse(
                    ...
                    req.getOldPhone(),
                    req.getNewPhone(),
                    user.getTelefono(), // teléfono actualizado en base de datos
