...
@Service
@Slf4j
public class WhatsappNotificationSenderMockImpl implements WhatsappNotificationSender {
    ...
    public String send(Notification notification) {
        ...
        log.info(
                "MOCK WHATSAPP SENT => notificationId={}, type={}, title={}, customerId={}, userId={}",
                notification.getId(),
        ...
        return "WA-MOCK-" + UUID.randomUUID();
    }
}